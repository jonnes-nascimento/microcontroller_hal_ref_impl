...
static const GpioConfig_t GpioConfig[] = {
        ...
        {CHANNEL_GP1, GPIO_PIN_FUNCTION_DIGITAL,            GPIO_PIN_DIRECTION_INPUT,  GPIO_PIN_PULLUP_DISABLED, GPIO_PIN_STATE_LOW,  GPIO_INTERRUPT_EDGE_NONE},
        {CHANNEL_GP2, GPIO_PIN_FUNCTION_EXTERNAL_INTERRUPT, GPIO_PIN_DIRECTION_INPUT,  GPIO_PIN_PULLUP_ENABLED,  GPIO_PIN_STATE_HIGH, GPIO_INTERRUPT_EDGE_RISING},
        {CHANNEL_GP3, GPIO_PIN_FUNCTION_DIGITAL,            GPIO_PIN_DIRECTION_INPUT,  GPIO_PIN_PULLUP_DISABLED, GPIO_PIN_STATE_LOW,  GPIO_INTERRUPT_EDGE_NONE},
        {CHANNEL_GP4, GPIO_PIN_FUNCTION_ANALOG,             GPIO_PIN_DIRECTION_INPUT,  GPIO_PIN_PULLUP_DISABLED, GPIO_PIN_STATE_HIGH, GPIO_INTERRUPT_EDGE_NONE},
        {CHANNEL_GP5, GPIO_PIN_FUNCTION_DIGITAL,            GPIO_PIN_DIRECTION_OUTPUT, GPIO_PIN_PULLUP_DISABLED, GPIO_PIN_STATE_HIGH, GPIO_INTERRUPT_EDGE_NONE}
};
